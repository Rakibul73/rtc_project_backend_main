...
def upload_seal():
    ...
    file.save(os.path.join(current_app.root_path, "upload/seal", file.filename))
...
def upload_signature():
    ...
    file.save(os.path.join(current_app.root_path,
              "upload/signature", file.filename))
...
def upload_profile_pic():
    ...
    file.save(os.path.join(current_app.root_path,
              "upload/profile_pic", file.filename))
...
def upload_methodology():
    ...
    file.save(os.path.join(current_app.root_path,
              "upload/methodology", file.filename))
...
def upload_nid():
    ...
    file.save(os.path.join(current_app.root_path, "upload/nid", file.filename))
...
def upload_project_softcopy():
    ...
    file.save(os.path.join(current_app.root_path,
              "upload/project_softcopy", file.filename))
...
def upload_monitoring_report_feedback():
    ...
    pdf_file.save(os.path.join(current_app.root_path,
                  "upload/monitoringreportfile", pdf_file.filename))
