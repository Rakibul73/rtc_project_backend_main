...
from github_webhook import github_webhook_blueprint
...
test_frontend_domain = os.environ.get('TEST_FRONTEND_DOMAIN')
main_frontend_domain = os.environ.get('MAIN_FRONTEND_DOMAIN')
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": [test_frontend_domain, main_frontend_domain]}})
Compress(app)
